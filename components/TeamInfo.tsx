    ...
    <div className={`relative flex flex-col items-center gap-2 w-[280px]`}>
      ...
      <div className="flex flex-col items-center gap-1 mt-2">
        ...
        <div className="flex flex-col items-center transition-transform duration-300 ease-out transform scale-100 z-10">
            <div className="w-20 h-20 rounded-full bg-white flex justify-center items-center text-5xl border-4 border-yellow-400 shadow-md">
        ...
        <div className="flex items-center gap-2 -mt-3">
            {waitingPlayers.map(player => (
                <div key={player.id} className="flex flex-col items-center opacity-70">
                    <div className="w-12 h-12 rounded-full bg-gray-200 flex justify-center items-center text-3xl border-2 border-gray-400 shadow-sm">
                        {player.avatarEmoji}
                    </div>
                </div>
            ))}
